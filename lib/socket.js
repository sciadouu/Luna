 ...
 */
! function(t, e) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self)._myExtensionSocketIO_  = e()
}(this, (function() {
	"use strict";
	...
	var lt = function(n) {
		...
		function a(n) {
			...
			return e(this, a), (r = s.call(this)).writeBuffer = [], n && "object" === t(n) && (o = n, n = null), n ? (n = ft(n), o.hostname = n.host, o.secure = "https" === n.protocol || "wss" === n.protocol, o.port = n.port, n.query && (o.query = n.query)) : o.host && (o.hostname = ft(o.host).host), D(f(r), o), r.secure = null != o.secure ? o.secure : "undefined" != typeof location && "https:" === location.protocol, o.hostname && !o.port && (o.port = r.secure ? "443" : "80"), r.hostname = o.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), r.port = o.port || ("undefined" != typeof location && location.port ? location.port : r.secure ? "443" : "80"), r.transports = o.transports || ["polling", "websocket"], r.writeBuffer = [], r.prevBufferLen = 0, r.opts = i({
				path: "/engine._myExtensionSocketIO_",
				agent: !1,
				withCredentials: !1,
				upgrade: !0,
				timestampParam: "t",
	...
	var Bt = Object.freeze({
		...
		St = function(t) {
			...
			function a(t, r, o) {
				var s;
				return e(this, a), (s = n.call(this)).connected = !1, s.recovered = !1, s.receiveBuffer = [], s.sendBuffer = [], s._queue = [], s._queueSeq = 0, s.ids = 0, s.acks = {}, s.flags = {}, s._myExtensionSocketIO_ = t, s.nsp = r, o && o.auth && (s.auth = o.auth), s._opts = i({}, o), s._myExtensionSocketIO_._autoConnect && s.open(), s
			}
			return r(a, [{
				key: "disconnected",
				get: function() {
				...
				value: function() {
					if (!this.subs) {
						var t = this._myExtensionSocketIO_;
				...
				key: "connect",
				value: function() {
					return this.connected || (this.subEvents(), this._myExtensionSocketIO_._reconnecting || this._myExtensionSocketIO_.open(), "open" === this._myExtensionSocketIO_._readyState && this.onopen()), this
				}
			}, {
				key: "open",
				value: function() {
				...
				value: function(t) {
					...
					var a = this._myExtensionSocketIO_.engine && this._myExtensionSocketIO_.engine.transport && this._myExtensionSocketIO_.engine.transport.writable,
				...
				value: function(t, e) {
					...
					if (void 0 !== i) {
						var o = this._myExtensionSocketIO_.setTimeoutFn((function() {
							delete r.acks[t];
						...
						this.acks[t] = function() {
							r._myExtensionSocketIO_.clearTimeoutFn(o);
				...
				key: "packet",
				value: function(t) {
					t.nsp = this.nsp, this._myExtensionSocketIO_._packet(t)
				}
			}, {
				key: "onopen",
				value: function() {
				...
				value: function() {
					this.subs && (this.subs.forEach((function(t) {
						return t()
					})), this.subs = void 0), this._myExtensionSocketIO_._destroy(this)
				}
			}, {
				key: "disconnect",
				value: function() {
	...
	function Pt(e, n) {
		...
		var r, i = function(t) {
			...
			}(e, (n = n || {}).path || "/socket._myExtensionSocketIO_"),
			o = i.source,
			s = i.id,
			a = i.path,
